                ...
                if not command.exclude_polygon or adj_area > min_adj_area:
                    ...
                    for interior in interiors:
                        ...
                        if not command.exclude_hole or adj_area > min_adj_area:
                            interior = LineStringSb(interior.coords, GenUtil.POLYGON_INTERIOR, min_adj_area, feature.sb_layer_name, None)
...
###            print('Iteration # {}'.format(iter_nbr))
            ...
            for line in lines:
                nbr_bend_simplified = line.simplify(self.command.dlayer_dict[line.sb_layer_name], s_constraints)
...
###        print('Total number of sidedness error: {}'.format(s_constraints.nbr_err_sidedness))
    ...
    def process(self):
        ...
        self.geo_content.nbr_bends_simplified += self._manage_lines_simplification(s_constraints)
